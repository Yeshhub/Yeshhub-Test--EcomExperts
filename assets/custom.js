// Assuming there is only one element with class 'product-form__input--dropdown'
var dropdown = document.querySelector('.product-form__input--dropdown');

// Assuming there is only one element with class 'swatches'
var swatches = dropdown.querySelector('.swatches');

// Assuming there is only one element with class 'select__select' within the next sibling of 'swatches'
